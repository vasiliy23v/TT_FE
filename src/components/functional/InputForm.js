        ...
        return (
            <div className="input-container">
                ...
                <div className='nav-container'>
                    <ChoiceButton type='nav-back' choice='back' onChoice={stepBack} label='Return Back' />
                    <ChoiceButton type='nav-forward' choice='submit' onChoice={onSubmit} label="Let's Play" />
                </div>
            </div>
        );
    } else {
